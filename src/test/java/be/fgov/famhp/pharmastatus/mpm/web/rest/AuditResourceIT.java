package be.fgov.famhp.pharmastatus.mpm.web.rest;

import be.fgov.famhp.pharmastatus.mpm.PharmaStatusMpmApp;
import be.fgov.famhp.pharmastatus.mpm.config.TestSecurityConfiguration;
import io.github.jhipster.config.JHipsterProperties;
import be.fgov.famhp.pharmastatus.mpm.config.audit.AuditEventConverter;
import be.fgov.famhp.pharmastatus.mpm.domain.PersistentAuditEvent;
import be.fgov.famhp.pharmastatus.mpm.repository.PersistenceAuditEventRepository;
import be.fgov.famhp.pharmastatus.mpm.security.AuthoritiesConstants;

import be.fgov.famhp.pharmastatus.mpm.service.AuditEventService;
...
@SpringBootTest(classes = {PharmaStatusMpmApp.class, TestSecurityConfiguration.class})
